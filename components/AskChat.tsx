...
const GREETING: Msg = {
  role: "assistant",
  content:
    "Tell me what kind of company you're after and I'll find people whose hours fit. Try: \"someone free Saturday mornings who likes chess\" or \"anybody free tomorrow\".",
};

// The Ask conversation, embeddable anywhere: full page or map overlay.
export default function AskChat({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className={`askChat${compact ? " compact" : ""}`}>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: m.content
                ...
                .replace(/(?<!["'=>])(https?:\/\/trycoincide\.vercel\.app\/(?:people|events)\/\d+)/g, '<a href="$1">profile</a>')
                .replace(/\n/g, "<br/>"),
            }}
          />
        ))}
